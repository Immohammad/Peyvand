...
const FullResearch = (props) => {
  return (
    <div className="container justify-content-center" id="eachFullResearch">
      <h2 style={{ color: "#027EA1" }}>{props.data.name}</h2>
      <p style={{ color: "#027EA1" }}>{props.data.area}</p>
      <p>{props.data.admin}</p>
      <hr />
      <p>
